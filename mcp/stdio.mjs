...
async function main() {
  ...
  console.error(
    `capability-model MCP: ${index.capabilities.length} capabilities, ${index.riskShapes.length} risk shapes, ${index.seams.length} seams, ${index.definitions.length} definitions, ${index.titles.length} titles, ${index.doctrine.length} doctrine, ${index.lifecycles.length} lifecycles`,
  );
